...
export const data:t.data = {
    ...
    actions: [
      {
        label: 'Go to Films',
        action: (row:t.planet) => { console.log(`redirect to grid with ${row.films.length} Films`)}
      },
      {
        label: 'Go to Residents',
        action: (row:t.planet) => { console.log(`redirect to grid with ${row.residents.length} Residents`)}
      }
    ]
  }